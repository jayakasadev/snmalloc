...
extern "C" {
    ...
    /// The program may be forced to abort if the constrains are not full-filled.
    pub fn sn_rust_dealloc(ptr: *mut c_void, alignment: usize, size: usize);
    ...
    pub fn sn_rust_statistics(current_memory_usage: *mut usize, peak_memory_usage: *mut usize);
}
...
extern "C" {
    ...
    pub fn sn_rust_profile_lifetime_histogram(out_buckets: *mut u64, len: usize) -> usize;
}
